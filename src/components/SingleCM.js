...
export default function SingleCM() {
  return (
    <Link href="/content-management/5" className='w-full flex items-center justify-between py-4 px-5 border-t border-solid border-[#E9E9EC]'>
        <div className='flex items-center gap-2 w-2/12'>
            <img src="/cm.svg" className='w-2/12 rounded-md' />
            <h6 className='text-[#252322] font-semibold text-sm'>Designed to give you mental peace </h6>
        </div>
        ...
        <h6 className='text-[#17161D] font-normal w-1/12 text-center text-base'>Audio</h6>
        <h6 className='text-[#17161D] font-normal w-12 text-center text-base'>110</h6>
        <h6 className='text-[#17161D] font-normal w-1/12 text-center text-base'>Feb 27, 2022</h6>
        <h6 className='text-[#17161D] font-normal w-14 text-center text-base'>9:30 AM</h6>
        <h6 className='text-[#17161D] font-normal w-12 text-center text-base'>Completed</h6>
