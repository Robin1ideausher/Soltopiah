...
function Header() {
  ...
  return (
    <div className='w-ful bg-[#D4D8F0] p-6 flex justify-end gap-6 '>
                ...
                {showDropDown && <div className='absolute top-16 p-3 bg-white rounded-lg w-[176px] shadow-lg flex flex-col gap-6'>
                  <div className='flex flex-row gap-2'>
                    <div className='bg-[#AE445A] p-3 rounded-full flex items-center'>
                    <ProfileIcon/>
                    </div>
                    <div className='flex flex-col gap-1'>
                      <p className='text-sm font-semibold font-sans text-deepBlue'>Rahul Admin</p>
                      <p className='text-xs font-normal font-sans text-[#3090E9]'>Email@gmail.com</p>
                    </div>
                  </div>
                  <div className='flex flex-row gap-3 items-center'>
                    <Notification/>
                    
                    <p className='font-sans font-normal text-black text-sm'>Notification setting</p>
                  </div>
                  <div className='flex flex-row gap-3 items-center'>
                    <Logout/>
